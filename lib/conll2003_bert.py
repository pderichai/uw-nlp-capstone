...
@DatasetReader.register("conll2003bert")
class Conll2003BertDatasetReader(DatasetReader):
    """
    ...
    def __init__(self,
                 ...
                 chosen_probability: float = 0.15) -> None:
        super().__init__(lazy)
        ...
        self.chosen_probability = chosen_probability
    ...
    def text_to_instance(self, # type: ignore
        ...
        for i in range(len(tokens)):
            if random.random() < self.chosen_probability:
                masks.append(1)
            else:
                masks.append(0)

        instance_fields['masks'] = SequenceLabelField(masks, sequence, "masks")
